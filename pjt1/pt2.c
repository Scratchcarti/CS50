...
int main()
{
	...
	again:
	    ...
	    printf("17.Euro(EUR) to Rupees  \n");
	    printf("18.Pound Sterling(GBP) to Rupees \n");
	    printf("19.Dollar(USD) to Rupees  \n");
	    printf("20.Australian Dollar(AUD) to Rupees  \n");
	    printf("21.Canadian Dollar(CAD) to Rupees  \n");
	    printf("22.South Korean Won(KRW) to Rupees  \n");
	    printf("23.Indonesian Rupiah(IDR) to Rupees  \n");
	    printf("24.Iranian Riyal(IRR) to Rupees  \n");
	    printf("25.Iraqi Dinar(IQD) to Rupees  \n");
	    printf("26.Japanese Yen(JPY) to Rupees  \n");
	    printf("27.Kuwaiti Dinar(KWD) to Rupees  \n");
	    printf("28.Malayasian Ringgit(MYR) to Rupees  \n");
	    printf("29.Pakistani Rupee(PKR) to Rupees  \n");
	    printf("30.Swiss Franc(CHF) to Rupees  \n");
	    printf("31.Vietnamese dong(VND) to Rupees  \n");
	    printf("32.Russian Ruble(RUB) to Rupees  \n");
	    scanf("%d",&userinput);
	    printf("\n");
